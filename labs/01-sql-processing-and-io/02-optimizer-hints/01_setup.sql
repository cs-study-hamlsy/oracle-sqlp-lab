prompt ============================================
prompt 옵티마이저 힌트 - 실습 환경 준비
prompt ============================================

/*
목적
- 고객/주문 데이터를 만들어 단일 테이블 힌트와 조인 힌트를 함께 실험한다.
- 선택도가 다른 조건을 일부러 섞어 FULL, INDEX, LEADING, USE_NL 차이를 확인한다.

체크 포인트
- CUSTOMER_CONTACTS, CUSTOMER_ORDERS 생성 여부
- 인덱스 생성 여부
- 통계정보 수집 여부
*/
